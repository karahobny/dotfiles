...
/* {{{ ALTERNATIVE FONTS?
static char font[] = "Droid Sans Mono Slashed:size=8:antialias=true:autohint=false";
static char font[] = "Source Code Pro:size=8:Semibold:antialias=true:autohint=false";
static char font[] = "xos4 Terminus:pixelsize=10:antialias=false";
}}} */

static char font[] = "Monaco for Powerline:size=8:bold:antialias=true:autohint=false";
